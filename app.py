...
const marwan =
    document.getElementById("marwan");
...
/*
====================================
CADA CUÁNTO APARECE UN TROLL

3000 ms = 3 segundos

Esto hace que el juego sea
más tranquilo.
====================================
*/
        ...
        */
        ...
        trolls.forEach((troll, ti) => {
            ...
            if (
                ...
                /*
                ====================================
                AUMENTO MUY SUAVE DE VELOCIDAD
...
function startGame() {
    ...
    */
    ...
    /*
    ====================================
    APARECEN TROLLS CADA 3 SEGUNDOS
    ====================================
    */
